...
# to check the columns/variables/features present in our data set
df.dropna(axis=0, how='any', inplace=True)
# print(df.head(5))
...
if __name__ == "__main__":
    ...
    # xoa cac item co tronf combobox
    # ui.cob_gioitinh.clear()    
    ...
    def click_submit(self):
        if   ui.txt_thunhap.text() != "" and ui.txt_thunhapnguoithan.text() != "" and ui.txt_sotienvay.text() != "" and ui.txt_tgvay.text() != "" :
            ...
            if logiRe.predict(mau_test) == 1:
                ...
                # kết quả trả về 
                ui.label_status.setText('ELIGIBLE')
                ui.label_status.setStyleSheet("border: 1px solid black; background-color: red")
